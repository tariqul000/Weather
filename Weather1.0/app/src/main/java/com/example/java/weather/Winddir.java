...
public class Winddir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        winddirTV = (TextView) findViewById(R.id.winddirTV);
    ...
    void getRetrofitObject() {
        ...
        call.enqueue(new Callback<Weather>() {
            ...
            public void onResponse(Call<Weather> call, Response<Weather> response) {Weather weather = response.body();
                ...
                windblowTV.setText("Wind Blow "+j+weather.getCurrent().getWindKph()+"Kph");
                winddirTV.setText("Wind Direction  "+k+weather.getCurrent().getWindDir());
