...
public class Current {
    ...
    public String getHumidity() {
        ...
        String stringHumidity = humidity.toString();
    ...
    public String getVisMiles() {
        ...
        int i = visMiles.intValue();
        String stringvisibility = Integer.toString(i);

        return stringvisibility+" mi";
    }
